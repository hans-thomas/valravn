<?php
    ...
    class Service extends Command {
         ...
         * @var string
         */
        protected $signature = 'valravn:service {name} {--namespace=} {--r|relations}';
        ...
        public function handle() {
            ...
            // crud service
            $crudService = $this->fs->read( "app/Services/stubs/CrudService.stub" );
            ...
            if ( $this->option( 'relations' ) ) {
                $crudService = $this->fs->read( "app/Services/stubs/RelationsService.stub" );
                $crudService = Str::replace( "{{CRUD-SERVICE::NAMESPACE}}", $namespace, $crudService );
                $crudService = Str::replace( "{{CRUD-SERVICE::MODEL}}", $singular, $crudService );
